...
pub static IDEVICE_UDID: Mutex<Option<String>> = Mutex::new(None);
pub static IDEVICE_OS_VERSION: Mutex<Option<String>> = Mutex::new(None);
pub static IDEVICE_PRODUCT_TYPE: Mutex<Option<String>> = Mutex::new(None);
